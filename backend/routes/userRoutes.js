...
// WRITE OPERATIONS
router.post("/create", requirePermission("add_employee"), upload.single("photo"), validate(userCreateSchema), addUser);
router.put("/:id", requirePermission("edit_employee"), upload.single("photo"), validate(updateUserSchema), updateUser);
...
// ROLE UPDATES
router.patch("/:id/role", requirePermission("manage_roles"), validate(roleUpdateSchema), updateUserRole);
