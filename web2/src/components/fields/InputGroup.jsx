  ...
  return (
    <div className="flex flex-col">
      ...
      <input
        ...
        className={`w-full px-3.5 py-2.5 bg-white border rounded-lg text-sm shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 transition-all duration-200 ${
          isError
