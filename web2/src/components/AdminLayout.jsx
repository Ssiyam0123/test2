...
const AdminLayout = () => {
  ...
  const { data: branchRes } = useBranches({}, { enabled: !!isSuperAdmin });
    ...
    () => [
      {
        ...
        items: [
          {
            name: hasPermission(PERMISSIONS.VIEW_ADMIN_DASHBOARD)
              ? "Global Dashboard"
              : "Branch Dashboard",
            href: "/admin",
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Master Syllabus",
            href: "/admin/manage-syllabus",
            icon: BookOpen,
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Log Purchase",
            href: "/admin/add-inventory",
            icon: PlusCircle,
            permission: PERMISSIONS.INVENTORY_ADD_STOCK,
          },
        ],
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Building2,
            permission: PERMISSIONS.BRANCH_EDIT,
          },
        ],
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: PlusCircle,
            permission: PERMISSIONS.ADD_BATCH,
          },
          {
            name: "Manage Batches",
          ...
          },
          {
            ...
            icon: ClipboardCheck,
            permission: PERMISSIONS.VIEW_ATTENDANCE_BOOK,
          },
          { name: "class-exp", href: "/admin/class-exp", icon: DollarSign },
        ],
      },
      {
        label: "Account",
        items: [
          {
            ...
            href: "/admin/profile",
            icon: UserPen,
            permission: PERMISSIONS.VIEW_MY_PROFILE,
          },
        ],
      },
      {
  ...
  return (
    <div className="min-h-screen bg-[#e8f0f2] relative flex overflow-x-hidden">
      ...
      {/* SIDEBAR */}
      <div
        className={`fixed z-40 bg-[#1e293b] shadow-2xl flex flex-col transition-all duration-300 inset-y-0 left-0 lg:inset-y-4 lg:left-4 lg:rounded-[2rem] lg:h-[calc(100vh-32px)] ${sidebarOpen ? "translate-x-0 w-64" : "-translate-x-full lg:translate-x-0"} ${isCollapsed ? "lg:w-24" : "lg:w-72"}`}
      >
        {/* LOGO */}
        <div
          ...
          <div className="flex items-center space-x-3">
            ...
            {!isCollapsed && (
              <div className="overflow-hidden flex-1">
                <p className="text-sm font-bold text-white truncate capitalize tracking-tight">
        ...
        {/* NAVIGATION */}
        <nav
          className={`flex-1 overflow-y-auto mt-4 px-3 space-y-1 scrollbar-hide ${isCollapsed ? "px-2" : "px-4"}`}
              ...
              {group.items.map((item) => {
                ...
                return (
                  ...
                  >
                    <item.icon
                      size={20}
                      className={`${isActive ? "text-[#14b8a6]" : "text-slate-500 group-hover:text-slate-300"}`}
                    />
                    {!isCollapsed && (
                      <span
      ...
      {/* MAIN CONTENT */}
      <div
        className={`relative z-0 flex flex-col min-h-screen w-full transition-all duration-300 ${isCollapsed ? "lg:pl-[112px]" : "lg:pl-[304px]"}`}
      >
